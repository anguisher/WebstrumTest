<div class="card shadow w-100">
	...
	<div class="card-body">
		...
		<div class="row w-100 m-0 webstrumPhotosRow">
			<div class="col-1 align-self-center m-1 webstrumUploadContainer" id="webstrumUploadPhoto">
			...
			<div class="col-1 align-self-center m-1 webstrumUploadContainer" id="webstrumUploadLoader">
				<div class="row h-100 w-100 m-0">
					<div class="col p-0 align-self-center">
						<div class="row h-100 w-100 m-0 justify-content-center">
